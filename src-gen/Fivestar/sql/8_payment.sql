...
--
-- Name: payment_comp fk_payment_bundling; Type: FK CONSTRAINT; Schema: public; Owner: deployer
--
...
--
-- Name: payment_comp fk_payment_ticket; Type: FK CONSTRAINT; Schema: public; Owner: deployer
--
