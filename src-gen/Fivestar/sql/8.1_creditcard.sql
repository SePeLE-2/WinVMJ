...
--
-- Name: payment_creditcard payment_creditcard_pkey; Type: CONSTRAINT; Schema: public; Owner: deployer
--

ALTER TABLE ONLY public.payment_creditcard
    ADD CONSTRAINT payment_creditcard_pkey PRIMARY KEY (id);


--
-- Name: payment_creditcard fk_payment_bundling; Type: FK CONSTRAINT; Schema: public; Owner: deployer
--
...
--
-- Name: payment_creditcard fk_payment_ticket; Type: FK CONSTRAINT; Schema: public; Owner: deployer
--
