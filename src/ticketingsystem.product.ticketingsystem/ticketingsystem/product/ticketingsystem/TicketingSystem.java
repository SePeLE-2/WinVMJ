package ticketingsystem.product.ticketingsystem;
...
public class TicketingSystem {
	...
	public static void main(String[] args) {
		...
		configuration.addAnnotatedClass(TicketingSystem.payment.ewallet.PaymentImpl.class);
	...
	public static void createObjectsAndBindEndPoints() {
        ...
        PaymentService ewalletPayment2Service = PaymentServiceFactory
            .createPaymentService("TicketingSystem.payment.ewallet.PaymentServiceImpl"
            	, paymentPayment2Service);		

        PaymentResource ewalletPayment2Resource = PaymentResourceFactory
            .createPaymentResource("TicketingSystem.payment.ewallet.PaymentResourceImpl"
		...
		System.out.println("ewalletPayment2Resource endpoints binding");
		Router.route(ewalletPayment2Resource);
		
		System.out.println("ewalletPayment2Service endpoints binding");
		Router.route(ewalletPayment2Service);
	...
	private static Map<String, Object> mappingFeatureModel() {
		...
		featureModelMappings.put(
			...
			new HashMap<String, String[]>() {{
				...
				put("deltas", new String[] {
					TicketingSystem.payment.ewallet.PaymentImpl.class.getName()
				});
			}}
        );
