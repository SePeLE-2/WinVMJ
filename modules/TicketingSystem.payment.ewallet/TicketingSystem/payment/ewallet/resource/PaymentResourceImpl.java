...
public class PaymentResourceImpl extends PaymentResourceDecorator {
	...
	// public Payment createPaymentEWallet(VMJExchange vmjExchange) {
	// PaymentEWallet paymentewallet = record.createPaymentEWallet(vmjExchange);
	// PaymentEWallet paymentewalletdeco =
	// PaymentEWalletFactory.createPaymentEWallet(
	...
	// public Payment createPaymentEWallet(VMJExchange vmjExchange, int id) {
	// PaymentEWallet paymentewallet = Repository.getObject(id);
	// int recordPaymentEWalletId = (((PaymentEWalletDecorator)
	// savedPaymentEWallet.getRecord()).getId());
	...
	// @Route(url = "call/ewallet/list")
	// public List<HashMap<String, Object>> getAllPaymentEWallet(VMJExchange
	// vmjExchange) {
	// List<PaymentEWallet> paymentewalletList =
	// Repository.getAllObject("paymentewallet_impl");
	// return transformPaymentEWalletListToHashMap(paymentewalletList);
	// }

	// public List<HashMap<String, Object>>
	// transformPaymentEWalletListToHashMap(List<PaymentEWallet> PaymentEWalletList)
	// {
	...
	// @Route(url = "call/ewallet/delete")
	// public List<HashMap<String, Object>> deletePaymentEWallet(VMJExchange
	// vmjExchange) {
	// if (vmjExchange.getHttpMethod().equals("OPTIONS")) {
	// return null;
	// }
